    ...
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div>
        ...
        <p className="text-sm md:text-base text-muted-foreground">
          Monitor your team's growth journey
        </p>
      </div>
      ...
      >
        {[
          ...
          },
          {
            ...
            value: `${
              typeof stats.averageConsistency === "number"
                ? stats.averageConsistency.toFixed(2)
                : "0.00"
            }%`,
            icon: TrendingUp,
          ...
          >
            <stat.icon
              className={`w-5 h-5 md:w-6 md:h-6 ${stat.color} mb-2 md:mb-3`}
            />
      ...
      <div className="grid lg:grid-cols-3 gap-4 md:gap-6">
        ...
        >
          <div className="flex items-center gap-2 mb-4 md:mb-6">
            ...
            <h2 className="font-display text-lg md:text-xl font-bold truncate">
              Top Performers
            </h2>
          </div>
              ...
              >
                ...
                <div className="text-right shrink-0">
                  <p className="font-bold text-primary text-sm md:text-base">
                    {typeof member.growthPlan?.consistencyScore === "number"
                      ? member.growthPlan.consistencyScore.toFixed(2)
                      : "0.00"}
                    %
                  </p>
        ...
        >
          ...
          <div className="space-y-4">
            {departments.map((dept) => {
              const safeProgress =
                typeof dept.avgProgress === "number" &&
                isFinite(dept.avgProgress) &&
                !isNaN(dept.avgProgress)
                  ? Math.max(0, Math.min(100, dept.avgProgress))
                  : 0;
              ...
              return (
                <div key={dept.name} className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <Progress value={safeProgress} className="h-2 flex-1" />
